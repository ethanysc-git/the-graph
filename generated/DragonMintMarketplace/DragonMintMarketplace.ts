...
export class DragonMintMarketplace__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class DragonMintMarketplace extends ethereum.SmartContract {
  static bind(address: Address): DragonMintMarketplace {
    return new DragonMintMarketplace("DragonMintMarketplace", address);
  }

  getListing(
    nftAddress: Address,
    tokenId: BigInt,
  ): DragonMintMarketplace__getListingResultValue0Struct {
    ...
    return changetype<DragonMintMarketplace__getListingResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getListing(
    nftAddress: Address,
    tokenId: BigInt,
  ): ethereum.CallResult<DragonMintMarketplace__getListingResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<DragonMintMarketplace__getListingResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
